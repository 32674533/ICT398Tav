...
int main()
{
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("../dependencies/textures/particle.bmp"));
	...
	*/
		...
		node = smgr->addAnimatedMeshSceneNode(smgr->getMesh("../dependencies/models/Tavern.3ds"),
